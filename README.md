...
<p>But, I decided to make it as separated topic for answering a question: "How to use Clover w/o installing macOS on UEFI-PC?". As we've known, provided Clover installer package is for using and running on Hackintosh based 
